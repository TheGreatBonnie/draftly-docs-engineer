...
- sessions
- organizations
- roles and permissions (including organization-scoped roles)
- OAuth authorization URLs and code exchange
- token creation
- signed webhooks
...
OAuth code exchange, token creation, and webhook signing are included as small primitives so later simulation scenarios have realistic code surfaces to evolve.
